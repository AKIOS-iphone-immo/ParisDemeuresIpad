...
- (void)viewDidLoad
{
    ...
    [bandeau setFrame:CGRectMake(0, 100, 768, 40)];
    ...
    [carte setFrame:CGRectMake(0, 300, 768, 600)];
    ...
    [boutonPrestige setFrame:CGRectMake(xPos + (xDecalage * 2) + 40,yPos,250,ySize)];
...
- (void) showButtonsAndLabels:(int)index{
    if ([[tableauAnnoncesTab objectAtIndex:index] count] > 0 ) {
        ...
        [badge setFrame:CGRectMake(xBadge, yBadge,50,50)];
        ...
        nbBiens.font = [UIFont fontWithName:@"Arial-BoldMT" size:22];
        
        [nbBiens setFrame:CGRectMake(xBadge - 1, yBadge + 8,50,30)];
